...
* https://www.elastic.co/kibana[kibana] - Data visualization and exploration tool for Elasticsearch.
...
* https://graylog.org/[graylog] - an open-source log management solution that collects, indexes, and analyzes log data.
